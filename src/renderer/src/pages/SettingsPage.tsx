...
import { ArrowResetRegular, InfoRegular } from '@fluentui/react-icons'
  ...
  return (
    <div className={styles.page}>
      ...
      <SectionCard
        ...
        actions={
          <Button appearance="subtle" icon={<ArrowResetRegular />} onClick={restoreLegalDefaults}>
            Gesetzliche Werte
          </Button>
        }
      >
      ...
      <SectionCard title="Export" description="Formatierung von CSV-, Excel- und PDF-Ausgaben">
        <Field label="CSV-Trennzeichen">
          <RadioGroup
            ...
            onChange={(_event, data) => set('csvDelimiter', data.value as Settings['csvDelimiter'])}
          >
